...
export const ERRORS = {
  ...
  REQUEST: {
    UNEXPECTED_RESPONSE: {
      code: '008',
      message: 'UNEXPECTED_RESPONSE: Server responded in an unexpected manner',
    } as IError,
    EXCEEDED_API_USAGE: {
      code: '009',
      message:
        'EXCEEDED_API_USAGE: Data access expired due to excessive usage. Please try again later',
    } as IError,
  },
};
